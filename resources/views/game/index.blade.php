...
@section('content')
	...
	<a id="switch-link" href="https://switch.vps.codegorilla.nl/game/{{$gameinfo->title}}">Watch it on <img src="https://switch.vps.codegorilla.nl/images/Switch-logo.png" alt="Switch"></a>
